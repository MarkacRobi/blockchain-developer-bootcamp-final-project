...
describe("RobiToken contract", function () {
  ...
  beforeEach(async function () {
    ...
    RobiToken = await ethers.getContractFactory(tokenName);
  ...
  describe("Transactions", function () {
    ...
    it("Should transfer tokens between accounts and create balance checkpoint", async function () {
      // Transfer 50 tokens from owner to addr1
      await hardhatToken.transfer(addr1.address, 50);
      const addr1Balance = await hardhatToken.balanceOf(
          addr1.address
      ...
      expect(+addr1LatestCheckpoint.balance).to.equal(25)
      expect(+addr1LatestCheckpoint.blockHeight).to.be.greaterThan(0);
